...
class AFilterScreen extends StatefulWidget {
  //static const routeName = '/emergencyFilter';

  @override
  _AFilterScreenState createState() => _AFilterScreenState();
}

class _AFilterScreenState extends State<AFilterScreen> {
  var labels;
  var startLabel;
  var endLabel;
  double minKm = 1;
